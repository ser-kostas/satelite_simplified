...
"""
Αυτός ο κώδικας ορίζει μια κλάση χρόνου για το GNSS που ονομάζεται gnsstime.
Επεκτείνει το πρότυπο datetime της Python για να συμπεριλάβει ειδικές μορφές χρόνου και
όπως εβδομάδες GPS, Ιουλιανές Ημέρες και Τροποποιημένες Ιουλιανές Ημέρες.

Δηλαδή, παρέχει εργαλεία για:

Μετατροπή μεταξύ ημερομηνιών ημερολογίου και μορφών ειδικών για το GNSS.

Συνοπτικά:
Είναι η κλάση που μας βοηθάει στο κύριο πρόγραμμα να μετατρέψουμε τις ημερομηνίες σε σωστή μορφή.
"""
...
"""
Αυτή η λειτουργία μετατρέπει όλες τις ημερομηνίες στη μορφή gnsstime.
Διασφαλίζει ότι οποιαδήποτε ημερομηνία θα είναι συμβατή με τους υπολογισμούς χρόνου GNSS.
"""
...
"""
Αυτή είναι η βασική κλάση.  

Μπορεί να δημιουργήσει ένα gnsstime όπως μια κανονική ημερομηνία (έτος, μήνας, ημέρα κ.λπ.). 
Μετατρέπει και 2ψήφια έτη όπως αυτά που βρίσκονται στα αρχεία RINEX (π.χ., το «21» γίνεται 2021).
"""
